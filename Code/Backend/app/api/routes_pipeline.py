...
@router.post("/run")
async def run_pipeline(request: Request, body: dict[str, Any]) -> dict[str, str]:
...
def get_pipeline_status(request: Request, run_id: str) -> dict[str, Any]:
...
def get_pipeline_run_graph(request: Request, run_id: str) -> dict[str, Any]:
